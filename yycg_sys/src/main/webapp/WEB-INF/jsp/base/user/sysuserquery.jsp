...
<script type="text/javascript">
	...
	function initGrid() {
		$('#sysuserlist').datagrid({
			...
			striped : true,
			//collapsible : true,
			url : '${baseurl}/sysuser/sysuserquery_result.action',
			//sortName : 'code',
			//sortOrder : 'desc',
			//remoteSort : false,
			idField : 'id',
...
<BODY>
	<div id="sysuserquery_div">
		<form id="sysuserqueryForm" name="sysuserqueryForm" method="post" action="${baseurl}/sysuser/sysuserquery_result.action&sts=1">
